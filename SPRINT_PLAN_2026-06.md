...
- Notes: Two of the four Sprint-2 items (2.2, 2.4) turned out already-satisfied by earlier work + the shared tile — verified before building (no wasted edits). Only 2.3's two confidence wires were net-new this checkpoint.
